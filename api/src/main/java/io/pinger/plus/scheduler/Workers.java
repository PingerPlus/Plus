...
public class Workers {
    ...
    public static Workers register(@NotNull String name, int threads) {
        return Workers.register(() -> {
            ...
            return new ForkJoinPool(threads, factory, new WorkerExceptionHandler(), false);
        });
    }
    ...
    public static class WorkerExceptionHandler implements UncaughtExceptionHandler {
        @Override
        public void uncaughtException(Thread t, Throwable e) {
            Instances.get(PluginLogger.class).warn("Thread {} threw an uncaught exception: {}", t.getName(), e);
        }
    }
}
